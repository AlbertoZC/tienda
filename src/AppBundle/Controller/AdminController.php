...
class AdminController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_show', array('username' => $admin->getUsername()));
        }
     ...
     *
     * @Route("/{username}", name="admin_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{username}/edit", name="admin_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Admin $admin)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_edit', array('username' => $admin->getUsername()));
        }
     ...
     *
     * @Route("/{username}", name="admin_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Admin $admin)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_delete', array('username' => $admin->getUsername())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
