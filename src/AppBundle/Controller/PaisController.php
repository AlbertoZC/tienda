...
class PaisController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('pais_show', array('nombre' => $pai->getNombre()));
        }
     ...
     *
     * @Route("/{nombre}/edit", name="pais_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Pais $pai)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('pais_edit', array('nombre' => $pai->getNombre()));
        }
    ...
    private function createDeleteForm(Pais $pai)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('pais_delete', array('nombre' => $pai->getNombre())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
