...
class StockController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('stock_show', array('productos' => $stock->getProductos()));
        }
     ...
     *
     * @Route("/{productos}", name="stock_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{productos}/edit", name="stock_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Stock $stock)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('stock_edit', array('productos' => $stock->getProductos()));
        }
     ...
     *
     * @Route("/{productos}", name="stock_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Stock $stock)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('stock_delete', array('productos' => $stock->getProductos())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
